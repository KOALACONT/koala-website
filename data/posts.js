...
module.exports = [
  {
    ...
    seoTitle: "What a shipping container costs in Australia",
    seoDesc: "The five things that set a shipping container's price in Australia: grade, size, which depot it sits in, how it reaches you and the market.",
    date: "2026-08-17",
    mins: 10,
...
`
  },
  {
    ...
    seoDesc: "When a container on your block is likely to need council approval, what councils actually assess, and how to ask yours for a usable answer.",
    date: "2026-08-16",
    mins: 9,
...
`
  },
  {
    ...
    seoDesc: "Relocating a shipping container: which truck suits, why it must be empty, how the lifting points work and the checks that decide if it can travel.",
    date: "2026-08-15",
    mins: 9,
...
`
  },
  {
    ...
    seoTitle: "Container markings: owner codes, numbers and the CSC plate",
    seoDesc: "How to read the numbers stencilled on a container: owner prefix, check digit, ISO size and type code, weight markings and the CSC plate.",
    date: "2026-08-14",
    mins: 9,
...
`
  },
  {
    ...
    seoTitle: "Container types explained: which shape solves which job",
    seoDesc: "General purpose, high cube, side opening, double door, open top, flat rack and dangerous goods containers: what each is for and when it is worth it.",
    date: "2026-08-13",
    mins: 9,
...
`
  },
  {
    ...
    seoTitle: "How long a shipping container lasts, and how to extend it",
    seoDesc: "What actually ends a shipping container's life on land, how long one can be expected to last, and the maintenance that adds years to it.",
    date: "2026-08-12",
    mins: 9,
