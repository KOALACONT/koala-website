...
${P.sizes.map((x, i) => sec(i % 2 === 0 ? "sec-wash" : "", secHead(x.short, x.title, null) + `<div class="twocol">
  <div class="reveal">${para(NOTES[x.slug] || [x.lead])}<p style="margin-top:1.2rem"><a class="btn btn-ghost" href="/${x.slug}/">${esc(x.title)} for sale and hire</a></p></div>
...
${sec("", `<div class="narrow">
  ...
  <h2>Cookies and advertising measurement</h2><p>We advertise on Google, Facebook and Instagram. Google's advertising tag measures enquiry submissions, phone-number taps and email-link taps. The Meta Pixel measures page visits and confirmed new enquiry submissions so we can understand and improve our Facebook and Instagram advertising. These services can receive page URLs, browser and device information, IP addresses and cookie or advertising identifiers, and may associate this activity with your account on their services. A phone-number tap is not proof of a completed call.</p>
  <p>We do not send the contents of the enquiry form, your name, phone number, email address, message, delivery address or financial information as advertising-event parameters. Automatic contact matching and automatic event collection are disabled for Meta; Google's enhanced conversions remain disabled. Your enquiry details go to our business systems and the service providers described above.</p>
  <p>We also keep campaign labels and an advertising click identifier, when supplied, in this browser tab for up to 30 minutes so an enquiry retains its source as you browse. This storage contains no enquiry details and is sent to our enquiry system with your form. The Meta Pixel does not load when your browser sends Global Privacy Control or Do Not Track. Browser tracking protection and content blockers can also limit advertising measurement; blocking cookies alone may not prevent all network requests. Your browser's privacy settings do not prevent you from using our enquiry form or contacting us. For more information, see <a href="https://www.facebook.com/privacy/policy/" rel="noopener">Meta's Privacy Policy</a> and <a href="https://policies.google.com/technologies/ads" rel="noopener">Google's advertising information</a>.</p>
